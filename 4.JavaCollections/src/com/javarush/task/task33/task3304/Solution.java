...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        test.writeValue(writer, one);
       // System.out.println(one.getClass().getSimpleName());
        //System.out.println(resultClassObject.getSimpleName());
        String str = writer.toString().replaceFirst(one.getClass().getSimpleName().toLowerCase(),
                resultClassObject.getSimpleName().toLowerCase());
       // System.out.println(str);

        Object ret = test.readValue(str, resultClassObject);
        return ret;
    }
